...
3. Add ``jsondatastore`` to the ``ckan.plugins`` setting in your CKAN
...
coverage installed in your virtualenv (``pip install coverage``) then run::
    ...
    nosetests --nologcapture --with-pylons=test.ini --with-coverage --cover-package=ckanext.jsondatastore --cover-inclusive --cover-erase --cover-tests


---------------------------------
Registering ckanext-jsondatastore on PyPI
---------------------------------

ckanext-jsondatastore should be availabe on PyPI as
https://pypi.python.org/pypi/ckanext-jsondatastore. If that link doesn't work, then
...
----------------------------------------
Releasing a New Version of ckanext-jsondatastore
----------------------------------------

ckanext-jsondatastore is availabe on PyPI as https://pypi.python.org/pypi/ckanext-jsondatastore.
